...
const PersonalDetailsForm = ({goBack}) => {
  const {
    register,
    handleSubmit,
    setValue,
...
<div className='row'>
      ...
      <div className="mb-3 col">
        ...
        <textarea className="form-control" {...register("permanentAddress", { required: true })} />
        {errors.permanentAddress && <span className="text-danger">Required</span>}
        <div className='mt-3'>
        <input
          type="checkbox"
      ...
      <div className="mb-3 col">
        ...
        />
        {errors.presentAddress && <span className="text-danger">Required</span>}
      </div>
</div>
